...
struct ContentView: View {
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle("Fasting Window")
            .toolbar {
    ...
    private var addSheet: some View {
        NavigationStack {
            ...
            .navigationTitle("New FastSession")
            .toolbar {
                ...
                ToolbarItem(placement: .confirmationAction) {
                    Button("Save") {
                        let entry = FastSessionEntry(title: newTitle.isEmpty ? "Untitled" : newTitle, note: newNote, value: newValue)
                        if store.add(entry) {
                            showAddSheet = false
                        } else {
                            showAddSheet = false
